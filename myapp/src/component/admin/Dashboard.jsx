...
event_busy
        ...
        <div className="right_text">
            <div className="info">
            <h3>On Leave</h3>
            <small class="text-muted">Total no. of employees on leave</small>
            </div>
...
delete_history
        ...
        <div className="right_text">
            <div className="info">
            <h3>Late</h3>
            <small class="text-muted">Total no. of employees running late to work</small>
            </div>
